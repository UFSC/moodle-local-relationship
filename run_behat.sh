...
#   CORE_NAME, DOCKER_VERSION, URL_NAME, PLUGIN_COMPONENT, PLUGIN_PATH, PLUGIN_TAG (opcional), SELENIUM_PORT (opcional)
#
# Pré-requisitos:
...
# ---------------------------------------------------------------------------
# Leitura do arquivo .env (pai do stack + local do plugin)
# ---------------------------------------------------------------------------
if [ -f "../../../../.env" ]; then
  set -a
  source ../../../../.env
...
# ---------------------------------------------------------------------------
# 4. Configurar Behat no config.php (se ainda não configurado)
# ---------------------------------------------------------------------------
...
# Auto-correção 2: behat_dataroot desatualizado (prefixo errado).
...
# Auto-correção 3: behat_wwwroot desatualizado (container name em vez do domínio).
...
# detectar isso aqui, ensure_behat_test_mode_enabled falharia mais tarde.
...
# ---------------------------------------------------------------------------
# 6. Habilitar explicitamente o modo de testes antes da execução
# ---------------------------------------------------------------------------
ensure_behat_test_mode_enabled
...
# Diagnóstico: verificar se a front page do site behat está acessível.
