 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class relationshipgroup_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_relationshipgroup_deleted', 'local_relationship');
    }
    ...
    public function get_description() {
        return "Relationship group {$this->objectid} was deleted by {$this->userid}";
    }
